...
const OTPVerification = () => {
    ...
    const [sendOTP] = useOTPverificationMutation();
        ...
        <div className="flex justify-center">
             <Card className="w-[40rem] shadow-lg">
                <CardHeader>
                    ...
                    <CardDescription>Hãy xác minh bằng cách nhập mã OTP được gửi đến email <strong>{email}</strong> để hoàn tất việc tạo tài khoản của bạn</CardDescription>
                </CardHeader>
